...
QueryPdpGroups
    ...
    ${resp}=  PapApiGetRequest  ${POLICY_PAP_IP}  /policy/pap/v1/pdps  200  null
...
QueryPolicyAudit
    ...
    ${resp}=  PapApiGetRequest  ${POLICY_PAP_IP}  ${url}  ${expectedstatus}  recordCount=1
...
QueryPolicyStatus
     ...
     ${resp}=  PapApiGetRequest  ${POLICY_PAP_IP}  /policy/pap/v1/policies/status  200  null
