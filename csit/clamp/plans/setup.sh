...
POLICY_RUNTIME_ACM_PORT=$(get-container-published-port.sh policy-clamp-runtime-acm)
...
POLICY_PARTICIPANT_PORT=$(get-container-published-port.sh policy-clamp-ac-pf-ppnt)
...
K8S_PARTICIPANT_PORT=$(get-container-published-port.sh policy-clamp-ac-k8s-ppnt)
HTTP_PARTICIPANT_IP=$(get-instance-ip.sh policy-clamp-ac-http-ppnt)
HTTP_PARTICIPANT_PORT=$(get-container-published-port.sh policy-clamp-ac-http-ppnt)
A1PMS_PARTICIPANT_IP=$(get-instance-ip.sh policy-clamp-ac-a1pms-ppnt)
A1PMS_PARTICIPANT_PORT=$(get-container-published-port.sh policy-clamp-ac-a1pms-ppnt)
