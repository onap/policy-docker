...
MetricsAfterExecution
    ...
    Should Contain  ${resp.text}  total_distribution_received_count_total 4.0
    Should Contain  ${resp.text}  distribution_success_count_total 4.0
    Should Contain  ${resp.text}  distribution_failure_count_total 0.0
    Should Contain  ${resp.text}  total_download_received_count_total 4.0
    Should Contain  ${resp.text}  download_success_count_total 4.0
